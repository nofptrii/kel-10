                        ...
                        <div class="header__top__inner">
                            <div class="header__top__left">
                                <ul>
                                    ...
                                    <li><a href="{{ asset('login') }}">Sign in</a> <span class="arrow_carrot-down"></span></li>
                                    <li><a href="{{ asset('register') }}">Sign up</a> <span class="arrow_carrot-down"></span></li>
                                </ul>
                            </div>
                ...
                <div class="testimonial__slider owl-carousel">
                    <div class="col-lg-6">
                        <div class="testimonial__item">
                            ...
                            <p>This cake is so good, i can't stop eating it!</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="testimonial__item">
